...
import { parseMTL } from "./utils/parseMTL.js";
import { generateTangents } from "./utils/generateTangents.js";

async function main() {
  // Get A WebGL context
  /** @type {HTMLCanvasElement} */
  const canvas = document.querySelector("#inspect__canvas");
  ...
  const objHref = "../objs/arma1/arma1.obj";
  ...
  const matTexts = await Promise.all(
    obj.materialLibs.map(async (filename) => {
      ...
      const response = await fetch("../objs/arma1/arma1.mtl");
